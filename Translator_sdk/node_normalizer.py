...
class NodeNormalizer:
    ...
    DEFAULT_URL = 'https://nodenorm.ci.transltr.io/'
    ...
    def get_normalized_nodes(self, query: str | list[str],
        ...
        **kwargs
        ...
        Examples
        --------
        >>> NodeNormalizer().get_normalized_nodes('MESH:D014867', return_equivalent_identifiers=False)
        ...
        """
        path = urllib.parse.urljoin(self.base_url, 'get_normalized_nodes')
    ...
    def get_preferred_names(self, id_list: list[str], batch_limit: int = 500, **kwargs) -> dict[str, str]:
        """
        ...
        **kwargs
        ...
        for index in range(0, len(id_list), batch_limit):
            ...
            normalized_nodes = self.get_normalized_nodes(id_sublist, mode='post', **kwargs)
    ...
    def ID_convert_to_preferred_name_nodeNormalizer(self, id_list):
        ...
        for index in range(0, len(id_list), NODENORM_BATCH_LIMIT):
            ...
            response = requests.post(self.base_url.rstrip('/') + '/get_normalized_nodes', json={
                "curies": id_sublist,
...
# These delegate to NodeNormalizer and will be removed before v1.0.
# ---------------------------------------------------------------------------
